// /src/controllers/metrics.controller.ts - Controller for API telemetry and performance metrics of the Mandelbrok8s orchestrator application
...
export class MetricsController {
  ...
  public static getMetrics(req: Request, res: Response): void {
    ...
    res.status(200).json({
      status: 'ok',
      service: 'mandelbrok8s-orchestrator',
